...
<section class="categories">
    ...
    <div class="box-container">
        <div class="box">
            <img src="uploaded_files/1.png" alt="Coconut Candle">
            <a href="menu.php?category=coconut" class="btn">Coconut</a>
        </div>
        <div class="box">
            <img src="uploaded_files/1.png" alt="Chocolate Candle">
            <a href="menu.php?category=chocolate" class="btn">Chocolate</a>
        </div>
        <div class="box">
            <img src="uploaded_files/1.png" alt="Strawberry Candle">
            <a href="menu.php?category=strawberry" class="btn">Strawberry</a>
        </div>
        <div class="box">
            <img src="uploaded_files/1.png" alt="Corn Candle">
